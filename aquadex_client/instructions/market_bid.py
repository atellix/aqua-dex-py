...
class MarketBidArgs(typing.TypedDict):
...
class MarketBidAccounts(typing.TypedDict):
    market: PublicKey
    state: PublicKey
    agent: PublicKey
    user: PublicKey
...
def market_bid(
    args: MarketBidArgs, accounts: MarketBidAccounts
    ...
    identifier = b"\xf0\xd6!H\xef\x19\xb4\xb1"
