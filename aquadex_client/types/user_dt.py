...
UserDTKind = typing.Union[UserRBACMap, UserRBAC]
UserDTJSON = typing.Union[UserRBACMapJSON, UserRBACJSON]


def from_decoded(obj: dict) -> UserDTKind:
...
def from_json(obj: UserDTJSON) -> UserDTKind:
